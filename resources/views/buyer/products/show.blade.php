		...
		<div class="card border-0 shadow-sm">
			<div class="card-body">
				...
				<div class="d-flex flex-wrap gap-2 mt-3">
					...
					<button type="button" class="btn p-0 border rounded-3 thumb-trigger" data-image="{{ asset($image) }}">
						<img src="{{ asset($image) }}" alt="thumb" width="72" height="72" style="object-fit: cover; border-radius: 0.5rem;" onerror="this.closest('button').style.display='none';">
					</button>
					@endforeach
				</div>
				@endif
